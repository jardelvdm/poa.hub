...
class Kirki_Control_Base extends WP_Customize_Control {
	...
	public function enqueue() {
		...
		wp_localize_script(
			...
			'kirkiL10n',
			array(
				'noFileSelected' => esc_attr__( 'No File Selected', 'epico' ),
				'remove'         => esc_attr__( 'Remove', 'epico' ),
				'default'        => esc_attr__( 'Default', 'epico' ),
				'selectFile'     => esc_attr__( 'Select File', 'epico' ),
				'standardFonts'  => esc_attr__( 'Standard Fonts', 'epico' ),
				'googleFonts'    => esc_attr__( 'Google Fonts', 'epico' ),
			)
		);
